...
txtAnnotate <- paste(txtAnnotate, "基本的に、曲線は右上がりなのでどれやっても戦闘力は上がる(あたりまえ！)", "\n", sep ="")
txtAnnotate <- paste(txtAnnotate, "平滑化曲線が線形で黒点と重なりが多い項目(闇の精霊、ボス知識、装備)は伸び幅が大きい or 付随して他の項目も上がりやすいやつだと思う。", "\n", sep ="")
...
txtAnnotate <- paste(txtAnnotate, "各項目の天井については、5000後半以降のデータが集まればよりはっきりすると思う。", "\n", sep ="")
txtAnnotate <- paste(txtAnnotate, "自分の戦闘力は4171なんで、討伐回してシルバー稼ぎながらシャカッて神話2スロ揃えつつ装備を育てるのが手っ取り早いが、もう討伐書ない。。。", "\n", sep ="")
